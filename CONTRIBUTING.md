...
5. Educational items, exercises, and activities. These could be components in .NET assemblies which are dynamically-loaded and unloaded at runtime, per extensibility. Alternatively, these could be workflows. In either case, educational items, exercises, and activities in other formats, e.g., QTI, can be "compiled" for use with Nifty.
   - Per the [use cases](https://github.com/AdamSobieski/Nifty/blob/master/OVERVIEW.md#use-cases), educational items, exercises, and activities could be mathematics exercises, interactive stories, software training exercises, and more.
